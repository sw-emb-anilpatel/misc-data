...
if [ "$TFA_FIP" == "" ] ; then
  ...
  if [ "$MACHINE" == "smarc-rzg2l" ] || [ "$MACHINE" == "smarc-rzg2lc" ] || [ "$MACHINE" == "smarc-rzv2l" ] || [ "$MACHINE" == "smarc-rzg2ul" ] || [ "$MACHINE" == "sm2s-rzg2ul" ] || [ "$MACHINE" == "sm2s-rzg2l" ] || [ "$MACHINE" == "sm2s-rzv2l" ]; then
    TFA_FIP=1
  else
    TFA_FIP=0
  fi
...
case "$MACHINE" in
  ...
  "sm2s-rzg2ul")
    TFA_OPT="BOARD=g2ul_smarc SOC_TYPE=1 SPI_FLASH=AT25SF321B"
    ;;
